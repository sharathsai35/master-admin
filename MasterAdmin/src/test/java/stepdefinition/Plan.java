...
public class Plan {
	...
	public void enter_notes_in_new_plan() throws InterruptedException {
		Thread.sleep(2000);
		WebElement e=driver.findElement(By.xpath("//textarea[@class='ui:textarea ui:resize-none ui:focus:textarea-primary ui:focus:border-none w-full h-[120px]']"));
		e.click();
		e.sendKeys("testing");
		Thread.sleep(1000);
	}
	...
	public void enter_notes_with_more_than_characters_in_new_plan() throws InterruptedException {
		...
		WebElement e=driver.findElement(By.xpath("//textarea[@class='ui:textarea ui:resize-none ui:focus:textarea-primary ui:focus:border-none w-full h-[120px]']"));
		e.click();
		e.sendKeys("Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan Enter Notes with more than 500 characters in new plan");
		Thread.sleep(1000);
	}
	...
	public void validate_the_reset_page_in_new_plan() throws InterruptedException {
		...
		Assert.assertEquals("", a1);
		Thread.sleep(1000);
		String a2=driver.findElement(By.xpath("//textarea[@class='ui:textarea ui:resize-none ui:focus:textarea-primary ui:focus:border-none w-full h-[120px]']")).getText();
	...
	public void validate_the_error_msg_with_entering_Reference_name_in_package_radiobutton() throws InterruptedException {
		Thread.sleep(2000);
		String a=driver.findElement(By.xpath("//div[text()='Package Name is required!']")).getText();
		Assert.assertEquals("Package Name is required!", a);
		Thread.sleep(1000);
	...
	public void validate_the_plans_page() throws InterruptedException {
		...
		String[] expectedArray = {
			    ...
			    + "TVerse Enterprise",
			    "P\n"
			    + "Bio Integration Premium",
			    "P\n"
			    + "Bio Enterprise",
			    "P\n"
			    + "IPhone Integration Enterprise",
			    "P\n"
			    + "Iphone Intergration Premium",
			    "E\n"
			    + "Iphone Premium Grit",
			    "E\n"
			    + "Android",
	...
	public void click_on_radiobutton_of_package_in_edit_plan() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[@class='ui:label-text ui:text-sm ui:text-[#333333] ui:cursor-not-allowed']")).click();
		Thread.sleep(1000);
	}
	...
	public void validate_the_clickable_package_or_not_in_edited_plan() throws InterruptedException {
		...
		Assert.assertEquals("Edit Plan (Myntra Enterprise)", a);
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//span[@class='ui:label-text ui:text-sm ui:text-[#333333] ui:cursor-not-allowed']")).getAttribute("class");
	...
	public void validate_the_editable_notes_or_not() throws InterruptedException {
		...
		Assert.assertEquals("Edit Plan (Myntra Enterprise)", a);
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//textarea[@class='ui:textarea ui:resize-none ui:focus:textarea-primary ui:focus:border-none w-full h-[120px]']")).getText();
	...
	public void validate_the_plan_details_which_is_edited_or_not_without_entering_mfa_code() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//input[@value='Myntra Enterprise']")).getAttribute("value");
		Assert.assertEquals("Myntra Enterprise", a);
		Thread.sleep(1000);
	...
	public void validate_the_notes_in_clone() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//textarea[@class='ui:textarea ui:resize-none ui:focus:textarea-primary ui:focus:border-none w-full h-[120px]']")).getText();
