...
public class Partner {
	...
	public void user_click_on_custom_range_and_select_the_date_range_from_last_to_starting_position() throws InterruptedException {
		Thread.sleep(2000);
		driver.findElement(By.xpath("//div[text()='Custom range']")).click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[text()='15']")).click();
	...
	public void user_validate_the_combination_of_deactivated_partner_search_partner_moniker() throws InterruptedException {
		Thread.sleep(1000);
	...
	public void user_validate_the_combination_of_deactivated_partner_search_name_of_who_added() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.assertEquals("No Records Found", a);
		Thread.sleep(1000);
	...
	public void validate_the_selected_date_is_cleared_or_not_validate_the_deactivated_partner_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='Filter by date']")).getText();
		Assert.assertEquals("Filter by date", a);
		Thread.sleep(1000);
	...
	public void validate_the_selected_date_is_cleared_or_not_validate_the_deactivated_partner_filter_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='Filter by date']")).getText();
		Assert.assertEquals("Filter by date", a);
		Thread.sleep(1000);
	...
	public void validate_the_selected_date_is_cleared_or_not_validate_the_deactivated_partner_filter_search_data() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='Filter by date']")).getText();
		Assert.assertEquals("Filter by date", a);
		Thread.sleep(1000);
	...
	public void validate_the_search_field_of_partner_validate_the_active_partner_filter_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//input[@placeholder='Search']")).getAttribute("placeholder");
		Assert.assertEquals("Search", a);
		Thread.sleep(1000);
	...
	public void validate_the_selected_date_is_cleared_or_not_validate_the_active_partner_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='Filter by date']")).getText();
		Assert.assertEquals("Filter by date", a);
		Thread.sleep(1000);
	...
	public void validate_the_selected_date_is_cleared_or_not_validate_the_active_partner_filter_search_data() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='Filter by date']")).getText();
		Assert.assertEquals("Filter by date", a);
		Thread.sleep(1000);
	...
	public void validate_the_column_filter_icon() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[@class='ui-pt-5 ui-flex ui-flex-col ui-gap-3 ui-text-sm']")).getText();
		Assert.assertEquals("S No\n"
				+ "Partner Company\n"
				+ "Partner Name\n"
				+ "Partner Moniker\n"
	...
	public void user_click_on_eye_icon_of_s_no() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-not-allowed ui-opacity-50')])[1]")).click();
		Thread.sleep(1000);
	}
	...
	public void validate_the_eye_icon_for_S_No() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-not-allowed ui-opacity-50')])[1]")).getAttribute("class");
	...
	public void user_click_on_eye_icon_of_partner_company() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-not-allowed ui-opacity-50')])[2]")).click();
		Thread.sleep(1000);
	}
	...
	public void validate_the_eye_icon_for_partner_company() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-not-allowed ui-opacity-50')])[2]")).getAttribute("class");
		Assert.assertEquals("ui-cursor-not-allowed ui-opacity-50 " , a);
		Thread.sleep(1000);
	}
	...
	public void user_click_on_eye_icon_of_partner_name() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-not-allowed ui-opacity-50')])[3]")).click();
		Thread.sleep(1000);
	}
	...
	public void validate_the_eye_icon_for_partner_name() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-not-allowed ui-opacity-50')])[3]")).getAttribute("class");
		Assert.assertEquals("ui-cursor-not-allowed ui-opacity-50 " , a);
		Thread.sleep(1000);
	}
	...
	public void validate_the_eye_icon_for_partner_moniker() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-pointer')])[1]")).getAttribute("class");
	...
	public void validate_the_eye_icon_for_phone_num() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-pointer')])[3]")).getAttribute("class");
		Assert.assertEquals("ui-cursor-pointer " , a);
		Thread.sleep(1000);
	}
	...
	public void validate_the_eye_icon_for_added_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-pointer')])[4]")).getAttribute("class");
		Assert.assertEquals("ui-cursor-pointer " , a);
		Thread.sleep(1000);
	}
	...
	public void validate_the_eye_icon_for_who_added() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-pointer')])[5]")).getAttribute("class");
		Assert.assertEquals("ui-cursor-pointer " , a);
		Thread.sleep(1000);
	}
	...
	public void validate_the_eye_icon_for_country() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-pointer')])[6]")).getAttribute("class");
		Assert.assertEquals("ui-cursor-pointer " , a);
		Thread.sleep(1000);
	}
	...
	public void validate_the_eye_icon_for_city() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][contains(@class,'ui-cursor-pointer')])[7]")).getAttribute("class");
		Assert.assertEquals("ui-cursor-pointer " , a);
		Thread.sleep(1000);
	}
	...
	public void validate_the_sort_by_option_is_clicked_or_not() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("(//*[name()='svg'][@class='ui-cursor-pointer ui-text-primary'])[1]")).getAttribute("class");
	...
	public void changed_alphabetic_order_from_z_to_a_for_Partner_Company() throws InterruptedException {
		...
		String[] companyArray = companies.stream()
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_search_input() throws InterruptedException {
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "S Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Qnu Labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_search_input_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
		...
		Thread.sleep(1000);
		String a2=driver.findElement(By.xpath("(//*[name()='svg'][@class='ui-cursor-pointer ui-text-[#999999]'])[1]")).getAttribute("class");
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_search_input_esc_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "ZTPC\n"
		...
		Assert.assertEquals("Search", a1);
		Thread.sleep(1000);
		String a2=driver.findElement(By.xpath("(//*[name()='svg'][@class='ui-cursor-pointer ui-text-primary'])[1]")).getAttribute("class");
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_search_input_clear_data() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Vi\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_Filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "S Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_filter_by_date_reset_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_filter_by_date_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_active_partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_deactivated_partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Qnu Labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_search_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_search_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Vi\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_search_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_active_partner_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "S Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_deactivated_partner_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_active_partner_filter_by_date_sarch() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_z_to_a_column_filter_deactivated_partner_filter_by_date_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_search_input() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_search_input_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_search_input_esc_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_search_input_clear_data() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_Filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_filter_by_date_reset_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_filter_by_date_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_active_partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_deactivated_partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_search_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_search_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_search_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_active_partner_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_deactivated_partner_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_active_partner_filter_by_date_sarch() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_company_a_to_z_column_filter_deactivated_partner_filter_by_date_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_search_input() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_search_input_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_search_input_esc_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_search_input_clear_data() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_Filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_filter_by_date_reset_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_filter_by_date_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_active_partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_deactivated_partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_search_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_search_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_search_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_active_partner_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_deactivated_partner_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_active_partner_filter_by_date_sarch() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_z_to_a_column_filter_deactivated_partner_filter_by_date_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_search_input() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Qnu Labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_search_input_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_search_input_esc_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_search_input_clear_data() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_Filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_filter_by_date_reset_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_filter_by_date_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_active_partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_deactivated_partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Qnu Labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_search_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_search_active_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_search_deactivated_partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_active_partner_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_deactivated_partner_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_active_partner_filter_by_date_sarch() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Bio\n"
	...
	public void validate_the_combination_of_sort_by_options_for_partner_Name_a_to_z_column_filter_deactivated_partner_filter_by_date_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "labs\n"
	...
	public void validate_alphabetic_order_from_z_to_a_for_partner_company_with_pagination() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 006\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_last_pagination_search_invalid() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.assertEquals("No Records Found" ,a);
		Thread.sleep(1000);
	...
	public void validate_alphabetic_order_from_z_to_a_for_partner_company_with_last_pagination() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("21\n"
				+ "Partner 001\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_last_pagination_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_last_pagination_search_clear_the_data() throws InterruptedException {
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_last_pagination_search_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Esc_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_filter_by_date_with_reset() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_filter_by_date_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 006\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_Active_Partner_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_Deactivated_Partner_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 006\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_column_filter_with_set_default() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 006\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_column_filter_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Active_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Active_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Active_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Deactivated_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Deactivated_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_Deactivated_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_Active_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_Active_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_Active_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_Deactivated_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_Deactivated_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_z_to_a_pagination_search_filter_by_date_Deactivated_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_alphabetic_order_from_a_to_z_for_partner_company_with_pagination() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Myntra\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_last_pagination_search_invalid() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.assertEquals("No Records Found" ,a);
		Thread.sleep(1000);
	...
	public void validate_alphabetic_order_from_a_to_z_for_partner_company_with_last_pagination() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("21\n"
				+ "Test 004\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_last_pagination_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_last_pagination_search_clear_the_data() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_last_pagination_search_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Esc_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_filter_by_date_with_reset() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_filter_by_date_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Partner XYZ\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_Active_Partner_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_Deactivated_Partner_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Partner XYZ\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_column_filter_with_set_default() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Partner XYZ\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_column_filter_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Active_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Active_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Active_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Deactivated_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Deactivated_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_Deactivated_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_Active_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_Active_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_Active_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_Deactivated_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_Deactivated_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_a_to_z_pagination_search_filter_by_date_Deactivated_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 004\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_last_pagination_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_last_pagination_search_invalid() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.assertEquals("No Records Found" ,a);
		Thread.sleep(1000);
	...
	public void validate_alphabetic_order_from_z_to_a_for_partner_name_with_last_pagination() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("21\n"
				+ "A Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_last_pagination_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_last_pagination_search_clear_the_data() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_last_pagination_search_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Esc_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_filter_by_date_with_reset() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_filter_by_date_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Airtel\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_Active_Partner_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_Deactivated_Partner_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Airtel\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_column_filter_with_set_default() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Airtel\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_column_filter_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 004\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Active_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 004\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Active_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Active_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Deactivated_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Deactivated_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_Deactivated_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 004\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Test 004\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_Active_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_Active_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_Active_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_Deactivated_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_Deactivated_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_z_to_a_pagination_search_filter_by_date_Deactivated_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_last_pagination_search() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_last_pagination_search_invalid() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.assertEquals("No Records Found" ,a);
		Thread.sleep(1000);
	...
	public void validate_alphabetic_order_from_a_to_z_for_partner_name_with_last_pagination() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("21\n"
				+ "Airtel\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_last_pagination_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_last_pagination_search_clear_the_data() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_last_pagination_search_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Esc_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_filter_by_date_with_reset() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "Test Partner\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_filter_by_date_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Bitcoin Inc\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_Active_Partner_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_Deactivated_Partner_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Bitcoin Inc\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_column_filter_with_set_default() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "Bitcoin Inc\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_column_filter_with_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Active_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Active_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Active_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "ZTPC\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Deactivated_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Deactivated_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_Deactivated_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("11\n"
				+ "IQ labs\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_Active_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_Active_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_Active_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_Active_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_Deactivated_Partner() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_Deactivated_Partner_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_Deactivated_Partner_column_filter() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='No Records Found']")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	...
	public void validate_the_combination_of_sort_by_option_for_Partner_Name_a_to_z_pagination_search_filter_by_date_Deactivated_Partner_column_filter_clear_button() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//tr[@class='ui-hover']")).getText();
		Assert.assertEquals("1\n"
				+ "K Verse\n"
	...
	public void click_on_partner_name_enter_partner_name() throws InterruptedException {
		...
		e.click();
		e.sendKeys("Naresh IT Solutions");
		Thread.sleep(1000);
	}
	...
	public void Validate_the_save_button_by_entering_only_Partner_Name_with_single_character() throws InterruptedException {
		Thread.sleep(1000);
	...
	public void click_on_partner_name_enter_partner_name_with_character() throws InterruptedException {
		...
		WebElement e=driver.findElement(By.xpath("//input[@placeholder='Partner Name']"));
		e.click();
		e.sendKeys("test test test test test test test test test test test test test test test test test test test test ");
		Thread.sleep(1000);
	}
	...
	public void Validate_the_save_button_by_entering_only_contact_Name_with_single_character() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='Partner Name is required!']")).getText();
		Assert.assertEquals("Partner Name is required!", a);
		Thread.sleep(1000);
	...
	public void Validate_the_save_button_by_entering_only_Partner_Moniker_with_single_character() throws InterruptedException {
		Thread.sleep(1000);
		String a=driver.findElement(By.xpath("//div[text()='Partner Name is required!']")).getText();
		Assert.assertEquals("Partner Name is required!", a);
		Thread.sleep(1000);
	...
	public void click_on_country_code_select_the_country_code() throws InterruptedException {
		Thread.sleep(1000);
		WebElement e=driver.findElement(By.xpath("//select[@class='ui-select ui-select-bordered ui-h-11 ui-min-h-11 ui-pe-8 ui-px-2 ui-shadow-sm ui-border-[#D0D5DD] h-[36px] min-h-[36px]']"));
		e.click();
	...
	public void click_on_address_enter_more_than_characters_in_address() throws InterruptedException {
		...
		WebElement e=driver.findElement(By.xpath("(//textarea)[1]"));
		e.click();
		e.sendKeys("test test test test test test test test test test test test test test test test test test test test test test test test test test");
		Thread.sleep(1000);
	}
	...
	public void validate_the_toast_msg_of_address() throws InterruptedException {
		Thread.sleep(100);
	    String a=driver.findElement(By.xpath("//div[text()='Maximum 100 characters are allowed for Address']")).getText();
	    Assert.fail(a);
	    Thread.sleep(1000);
	 }
	...
	public void validate_the_toast_msg_of_bank_details() throws InterruptedException {
		Thread.sleep(100);
	    String a=driver.findElement(By.xpath("//div[text()='Maximum 100 characters are allowed for Bank Details']")).getText();
	    Assert.fail(a);
	    Thread.sleep(1000);
	}
	...
	public void validate_the_searched_role_name_in_contacts_page() throws InterruptedException {
	    String a=driver.findElement(By.xpath("//div[text()='Sales']")).getText();
	    Assert.assertEquals("Sales", a);
	    Thread.sleep(1000);
	}
	...
	public void enter_the_name_with_more_than_character_in_contacts_tab() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@placeholder='Contact Name']")).sendKeys("test test test test test test test test test test test test test test");
		Thread.sleep(1000);
	}
	...
	public void enter_the_email_id_in_contacts_tab() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@placeholder='Email Address']")).sendKeys("sharath@gmail.com");
		Thread.sleep(1000);
	}
	...
	public void enter_the_mobile_num_in_contacts_tab() throws InterruptedException {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@placeholder='Mobile Number']")).sendKeys("9874678797");
		Thread.sleep(1000);
	}
	...
	public void validate_the_doc_tab() throws InterruptedException {
	    ...
	    Assert.assertEquals("Select files or drag and drop here\n"
	    		+ "JPG, PNG or PDF, file size no more than 10MB", a1);
	    Thread.sleep(1000);
	}
	...
	public void select_the_image_of_jpg_click_on_that_image() throws InterruptedException, AWTException {
		Robot rb= new Robot();
		Thread.sleep(1000);
		StringSelection str = new StringSelection("/home/tvisha/Downloads/Screenshot_20250707_144414_TroopMessenger.jpg");
		Toolkit.getDefaultToolkit().getSystemClipboard().setContents(str, null);
		Thread.sleep(2000);
		rb.keyPress(KeyEvent.VK_CONTROL);
		rb.keyPress(KeyEvent.VK_V);
	...
	public void click_on_select_in_Plan_tab() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@title='Select']")).click();
		Thread.sleep(1000);
	}
	...
	public void select_the_Plan_in_dropdown_list() throws InterruptedException {
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[text()='Bio Premium']")).click();
		Thread.sleep(1000);
	}
	...
	public void validate_the_selected_Plan() throws InterruptedException {
	    String a=driver.findElement(By.xpath("//div[@title='Bio Premium']")).getText();
	    Assert.assertEquals("Bio Premium", a);
	    Thread.sleep(1000);
	}
	...
	public void validate_the_searched_Plan() throws InterruptedException {
		String a=driver.findElement(By.xpath("//div[text()='Bio Premium']")).getText();
	    Assert.assertEquals("Bio Premium", a);
	    Thread.sleep(1000);
	}
	...
	public void validate_the_package_plan_page() throws InterruptedException {
	    String a1=driver.findElement(By.xpath("(//div[@class='border border-gray-300 rounded-[10px] p-[10px] bg-[#F5F5F5]'])[1]")).getText();
	...
	public void validate_the_package_tab_by_clicking_on_add_more_button_with_reset_button() throws InterruptedException {
	    String a1=driver.findElement(By.xpath("//div[text()='Select Package:']")).getText();
	    Assert.assertEquals("Select Package:", a1);
	    Thread.sleep(1000);
	    String a=driver.findElement(By.xpath("//div[text()='Select Package:']")).getText();
	...
	public void validate_the_package_tab_by_clicking_on_add_more_button_with_close_button() throws InterruptedException {
	    String a1=driver.findElement(By.xpath("//body[1]/div[1]/div[1]/h2[1]")).getText();
	    Assert.assertEquals("Application error: a client-side exception has occurred while loading 192.168.2.19 (see the browser console for more information).", a1);
	    Assert.fail(a1);
	    Thread.sleep(1000);
//	    String a=driver.findElement(By.xpath("//div[text()='Select Package:']")).getText();
//	    Assert.assertEquals("Select Package:", a);
	...
	public void validate_the_dropdown_with_packages() throws InterruptedException {
	    String a=driver.findElement(By.xpath("//div[text()='Bio Integration']")).getText();
	    Assert.assertEquals("Bio Integration", a);
	    Thread.sleep(1000);
	}
	...
	public void validate_the_pricing_tab() throws InterruptedException {
	    ...
	    Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("//button[@class='ui-py-2 ui-text-sm ui-font-medium ui-transition-colors ui-duration-300 ui-text-[#243A49] ui-cursor-not-allowed']")).getAttribute("class");
	    Assert.assertEquals("ui-py-2 ui-text-sm ui-font-medium ui-transition-colors ui-duration-300 ui-text-[#243A49] ui-cursor-not-allowed", a1);
	    Thread.sleep(1000);
	}
	...
	public void click_on_outside_in_pricing_tab() throws InterruptedException {
		Thread.sleep(1000);
		WebElement e=driver.findElement(By.xpath("(//div[@class='ui-fixed ui-top-0 ui-left-0 ui-w-full ui-h-full ui-z-[9999]'])[1]"));
		e.click();
		Thread.sleep(1000);
	}
	...
	public void validate_the_dropdown_list_with_reset_in_pricing_tab() throws InterruptedException {
		...
		Assert.assertEquals("", a);
	    Thread.sleep(1000);
	    String a1=driver.findElement(By.xpath("(//div[@class='ui-absolute ui-top-[34px] ui-z-[9999] ui-border ui-border-[#E0DCDC] ui-shadow-md ui-rounded-lg ui-w-[250px] ui-px-5 ui-py-6 ui-bg-white'])[1]")).getText();
	    Assert.assertEquals("All\n"
	    		+ "₹ Indian Rupee\n"
	    		+ "$ United States Dollar\n"
	    		+ "€ Euro\n"
	...
	public void validate_the_currency_page_of_selected_all() throws InterruptedException {
		...
		Assert.assertEquals("₹\n"
				...
				+ "EUR", a);
	    Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("(//div[@class='bg-white rounded-[10px] border border-[#0000004D] shadow-sm pt-4 pb-3'])[1]")).getText();
	...
	public void validate_the_currency_page_of_selected_rupees() throws InterruptedException {
		String a=driver.findElement(By.xpath("(//div[@class='flex justify-between gap-2 items-center bg-[#FCEFDA] rounded-md px-[5px] text-[13px]'])[1]")).getText();
		Assert.assertEquals("₹\n"
				+ "INR", a);
	    Thread.sleep(1000);
		String a1=driver.findElement(By.xpath("(//div[@class='bg-white rounded-[10px] border border-[#0000004D] shadow-sm pt-4 pb-3'])[1]")).getText();
	...
	public void validate_the_currency_page_of_selected_rupees_with_edition_id() throws InterruptedException {
		String a=driver.findElement(By.xpath("(//div[@class='flex justify-between items-center text-[#222222]'])[1]")).getText();
		Assert.fail(a);
		Thread.sleep(1000);
	}
	...
	public void validate_the_pricing_page_in_package_with_reset() throws InterruptedException {
		String a=driver.findElement(By.xpath("(//div[@class='bg-white rounded-[10px] border border-[#0000004D] shadow-sm pt-4 pb-3'])[1]")).getText();
		Assert.assertEquals("Pricing Type\n"
				+ "Flat Rate\n"
				+ "Variable Rate\n"
				+ "Pricing\n"
	...
	@Then("Click on Submit button in Stores")
	public void click_on_Submit_button_in_stores() throws InterruptedException {
		Thread.sleep(1000);
	...
	public void attach_the_attachment_in_first_logo() throws InterruptedException, AWTException {
		...
		Robot rb= new Robot();
		Thread.sleep(1000);
		StringSelection str = new StringSelection("/home/tvisha/Downloads/Document-Write-icon_11zon.png");
		Toolkit.getDefaultToolkit().getSystemClipboard().setContents(str, null);
		Thread.sleep(2000);
		rb.keyPress(KeyEvent.VK_CONTROL);
		rb.keyPress(KeyEvent.VK_V);
	...
	@Then("Attach the attachment in favicon")
	public void attach_the_attachment_in_favicon() throws InterruptedException, AWTException {
		driver.findElement(By.xpath("//button[text()='UPLOAD']")).click();
		Thread.sleep(2000);
		Robot rb= new Robot();
		Thread.sleep(1000);
		StringSelection str = new StringSelection("/home/tvisha/Documents/favicon.ico");
		Toolkit.getDefaultToolkit().getSystemClipboard().setContents(str, null);
		Thread.sleep(2000);
		rb.keyPress(KeyEvent.VK_CONTROL);
		rb.keyPress(KeyEvent.VK_V);
	...
	@Then("Attach the attachment in textual logo")
	public void attach_the_attachment_in_textual_logo() throws InterruptedException, AWTException {
		driver.findElement(By.xpath("(//button[text()='UPLOAD'])[2]")).click();
		Thread.sleep(2000);
		Robot rb= new Robot();
		Thread.sleep(1000);
		StringSelection str = new StringSelection("/home/tvisha/Downloads/Document-Write-icon_11zon.png");
	...
	public void validate_the_deactivate_popup_page() throws InterruptedException {
	    ...
	    Assert.assertEquals("Partner: Naresh IT Solutions\n"
